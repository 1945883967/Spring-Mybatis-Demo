package com.minghai1.dynamicProxy;
 ...
 * 问题二：当通过代理类的对象调用方法时，如何动态的去调用被代理类中同名的方法。
 */
class ProxyFactory{
    // 调用此方法，返回一个代理对象，解决问题一
...
class MyInvocationHandler implements InvocationHandler{
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        // method：即为代理对象调用的方法，此方法也就作为了被代理类对象调用的方法
        // obj:被代理类的对象
